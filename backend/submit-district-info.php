...
try {
    ...
    $sql = "INSERT INTO districts (district_name, title, description, file_path, link_url, date_created, created_by, is_active) 
            VALUES (:district_name, :title, :description, :file_path, :link_url, :date_created, :created_by, FALSE)";
